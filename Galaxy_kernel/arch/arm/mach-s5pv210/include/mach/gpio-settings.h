...
#else
	{S5PV210_GPJ4(4), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, 
#endif
	// MP01 --------------------------------------------------------------------
...
static unsigned int sleep_gpio_table[][3] =
{
	...
	{S5PV210_GPB(1),  S3C_GPIO_SLP_INPUT,  S3C_GPIO_PULL_DOWN},	//GPIO_MSENSE_nRST    	// [HDLNC] REV 03 hawk
...
//	{S5PV210_GPJ3(2), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},	//_3_GPIO_TOUCH_EN
        {S5PV210_GPJ3(2), S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE},      //_3_GPIO_TOUCH_EN // for BLN for i9000
...
#endif
	#if defined (CONFIG_S5PC110_HAWK_BOARD) /* nat */
	//{S5PV210_GPH1(1), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, /* XEINT[9] GPH1[1] for CP_PWR_RST */
	#else
...
#else
	#if defined (CONFIG_S5PC110_HAWK_BOARD) /* nat */
	//{S5PV210_GPH1(2), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_UP},	/*XEINT[10], GPIO_GPH1[2] for ALS_INT */
	#else
	{S5PV210_GPH1(2), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, //GPIO_GPH11
	#endif
#endif
#if defined (CONFIG_S5PC110_HAWK_BOARD) /* nat */
	//{S5PV210_GPH1(4), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE},	/* XEINT[12], GPIO_GPH1[4] for INT_RESOUT */
	{S5PV210_GPH1(5), S3C_GPIO_OUTPUT,	S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_NONE},	//GPIO_GPH15 	//[HDLNC] REV 03 hawk NC
	//{S5PV210_GPH1(6), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE},	/* XEINT[14], GPIO_GPH1[6] for SIM_nDETECT */
#else
...
#endif
#if defined (CONFIG_S5PC110_HAWK_BOARD) /* nat */
	//{S5PV210_GPH3(0), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_UP},	//XEINT[24], GPH3[0] for HOME_KEY
#else
