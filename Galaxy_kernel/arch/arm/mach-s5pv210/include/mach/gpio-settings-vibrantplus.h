...
{
	// GPA0 --------------------------------------------------------------------
	#if defined(CONFIG_GPS_CHIPSET_STE_CG2900) && defined (CONFIG_S5PC110_VIBRANTPLUS_BOARD) /* STE for CG2900 */ // T959P
	#else // T959V
	{S5PV210_GPA0(6), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, // NC
	...
	{S5PV210_GPD1(2), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, // NC
	{S5PV210_GPD1(3), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, // NC
	...
	// GPG0 --------------------------------------------------------------------
	{S5PV210_GPG0(0), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_DOWN}, // NC
	...
	{S5PV210_GPH2(1), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_DOWN}, // NC
...
#else
	{S5PV210_GPH3(7), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_DOWN}, // NC
#endif
	...
	{S5PV210_GPJ2(4), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, // NC
	...
	{S5PV210_GPJ2(7), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_DOWN}, // NC
...
// HDLNC_BP_pyoungkuenoh_20110223 - EarMic Bias Output Setting
	{S5PV210_GPJ4(4), S3C_GPIO_OUTPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, 
#else
	{S5PV210_GPJ4(4), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, // NC
#endif
	// MP01 --------------------------------------------------------------------
...
//#if defined CONFIG_S5PC110_T959_BOARD || defined CONFIG_S5PC110_KEPLER_BOARD || defined CONFIG_S5PC110_FLEMING_BOARD
//	{S5PV210_GPD1(2), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},	//GPIO_GPD12
//	{S5PV210_GPD1(3), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},	//GPIO_GPD13
//#else

	{S5PV210_GPD1(2), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},	//GPIO_GPD12	// [HDLNC] REV 03 hawk
	{S5PV210_GPD1(3), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},	//GPIO_GPD13	// [HDLNC] REV 03 hawk
...
//#endif	
	...
	// GPG0 -------------------------------------------------
	{S5PV210_GPG0(0), S3C_GPIO_SLP_INPUT,  S3C_GPIO_PULL_DOWN},	//GPIO_NAND_CLK
	{S5PV210_GPG0(1), S3C_GPIO_SLP_INPUT,  S3C_GPIO_PULL_DOWN},	//GPIO_NAND_CMD
#if defined(CONFIG_ARIES_NTT)	
	{S5PV210_GPG0(2), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},	//GPIO_ALS_SCL_28V
#else
#if defined(CONFIG_S5PC110_KEPLER_BOARD)
	{S5PV210_GPG0(2), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_UP},	// GPIO_ALS_SCL_28V
#else
	{S5PV210_GPG0(2), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},	// GPIO_ALS_SCL_28V
#endif
#endif
	{S5PV210_GPG0(3), S3C_GPIO_SLP_INPUT,  S3C_GPIO_PULL_DOWN},	//GPIO_NAND_D0
	{S5PV210_GPG0(4), S3C_GPIO_SLP_INPUT,  S3C_GPIO_PULL_DOWN},	//GPIO_NAND_D1
	{S5PV210_GPG0(5), S3C_GPIO_SLP_INPUT,  S3C_GPIO_PULL_DOWN},	//GPIO_NAND_D2
	{S5PV210_GPG0(6), S3C_GPIO_SLP_INPUT,  S3C_GPIO_PULL_DOWN},	//GPIO_NAND_D3
...
#else
#if defined(CONFIG_S5PC110_KEPLER_BOARD)
	{S5PV210_GPG2(2), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_UP},	//GPIO_ALS_SDA_28V
#else
	...
	{S5PV210_GPJ2(4), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},	//GPIO_USIM_BOOT
		...
		{S5PV210_GPJ2(4), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},	//[HDLNC] REV 03 hawk NC
	...
	{S5PV210_GPJ2(7), S3C_GPIO_SLP_INPUT,  S3C_GPIO_PULL_DOWN},	//GPIO_MASSMEMORY_EN //[sikim]
	// GPJ3 -------------------------------------------------
...
//]hdlnc_ldj 20100915 [P100914-0828]fix sleep current issue while inserting	earjack
	// MP01 -------------------------------------------------
	{S5PV210_MP01(0), S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE},	//GPIO_MP010
...
#if defined(CONFIG_KEPLER_AUDIO_A1026)
...
#endif	
//[hdlnc_ldj 20100915 [P100914-1057]fix mute issue whe sleep in voice call
#if defined(CONFIG_KEPLER_AUDIO_A1026)
#else
#if defined(CONFIG_HAWK_VER_B1_REAL_ADDED_FEATURE) //NAGSM_Android_HQ_KERNEL_CLEE_20100908 : Setup Hawk Real Board Rev 0.1 Proximity sensor
	{S5PV210_GPH1(2), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_UP},	//GPIO_GPH11
#else
